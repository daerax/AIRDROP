...
def main():
    ...
    auto_upgrade_spinner = 'y' #input("Auto upgrade? y / n (default n): ").strip().lower()
    # Tambahkan pertanyaan untuk mengaktifkan roket
    activate_rocket = 'y' #input("Gunakan Roket? y / n (default n): ").strip().lower()
    # Tambahkan pertanyaan untuk mengaktifkan full hp
    activate_fullhp = 'y' #input("Gunakan Bonus HP? y / n (default n): ").strip().lower()
    # Tambahkan pertanyaan untuk auto claim reward
    auto_claim_reward = 'n' #input("Auto clear task? y / n (default n): ").strip().lower()
    # Tambahkan pertanyaan untuk auto claim daily reward
    auto_claim_daily = 'y' #input("Auto claim daily reward? y / n (default n): ").strip().lower()

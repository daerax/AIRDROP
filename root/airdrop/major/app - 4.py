...
class Major:
    ...
    async def visit(self, token: str):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Daily Visit: {str(e.message)} ]{Style.RESET_ALL}")
    ...
    async def streak(self, token: str):
        ...
        try:
            ...
            self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Fetching Streak: {str(e.message)} ]{Style.RESET_ALL}")
            return None
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def user(self, token: str, id: str):
        ...
        try:
            ...
            self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Fetching User: {str(e.message)} ]{Style.RESET_ALL}")
            return None
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def join_squad(self, token: str):
        ...
        try:
            async with aiohttp.ClientSession(timeout=aiohttp.ClientTimeout(total=20)) as session:
                async with session.post(url=url, headers=headers) as response:
                    if response.status in [500, 520]: return
                    response.raise_for_status()
                    join_squad = await response.json()
                    if join_squad['status'] == 'ok': return
    ...
    async def complete_task(self, token: str, task_title: str, task_award: int, payload: dict):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Complete Tasks: {str(e.message)} ]{Style.RESET_ALL}")
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def durov(self, token: str, answer: dict):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Play Durov: {str(e.message)} ]{Style.RESET_ALL}")
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def coins(self, token: str, reward_coins: int):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Play Hold Coins: {str(e.message)} ]{Style.RESET_ALL}")
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def roulette(self, token: str):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Play Roulette: {str(e.message)} ]{Style.RESET_ALL}")
        except (Exception, aiohttp.ContentTypeError) as e:
    ...
    async def swipe_coin(self, token: str, reward_swipe_coins: int):
        ...
        try:
            ...
            return self.print_timestamp(f"{Fore.RED + Style.BRIGHT}[ An HTTP Error Occurred While Play Swipe Coin: {str(e.message)} ]{Style.RESET_ALL}")
        except (Exception, aiohttp.ContentTypeError) as e:

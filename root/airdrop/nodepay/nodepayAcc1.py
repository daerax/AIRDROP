...
async def main():
    ...
    token = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMzA1MDU4ODE2MTc3NDcxNDg4IiwiaWF0IjoxNzMxNTEzMzk2LCJleHAiOjE3MzI3MjI5OTZ9.Wi1BSwILEKiGB28HH0xIzQLYrh6q2UgVrPFP4P7Nqqj9XnIj5lvVPUq9rAVeyKuJJKpEK0gqBsTW6B3GxYzghA'#input("Nodepay token: ").strip()
    if not token:
